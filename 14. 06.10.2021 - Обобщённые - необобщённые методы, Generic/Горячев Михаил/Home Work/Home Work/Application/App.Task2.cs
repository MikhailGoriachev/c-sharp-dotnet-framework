...
namespace Home_Work.Application
{
    ...
    {
        #region 2. Обработка массива double
        ...
        public void Task2()
        {
            ...
            while (true)
            {
                ...
                // заголовок
                Console.SetCursorPosition(x + 3, y); WriteColor($"{"    2. Обработка массива double"}", ConsoleColor.Blue);
                ...
                Console.SetCursorPosition(x, y++); Console.WriteLine("3. Определение количества максимальных элементов ");
                Console.SetCursorPosition(x, y++); Console.WriteLine("4. Упорядочивание массива по убыванию");
                ...
                try
                {
                    ...
                    switch (numberTask)
                    {
                        ...
                        // 3. Определение количества максимальных элементов 
            ...
            #region 3. Определение количества максимальных элементов 

            // 3. Определение количества максимальных элементов 
            void Point3()
            {
                ShowNavBarMessage("3. Определение количества максимальных элементов ");
            ...
            #region 4. Упорядочивание массива по убыванию

            // 4. Упорядочивание массива по убыванию
            void Point4()
            {
                ShowNavBarMessage("4. Упорядочивание массива по убыванию");
