...
namespace Home_Work.Controllers
{
    ...
    {
        // массив 
        public StorageArray<double> Data { get; set; } = new StorageArray<double>();
        ...
        public void Initialization() => Data.Initialization(() => GetDouble(-3, 3));
        ...
        #region Количество максимальных элементов 
        ...
        public void ShowColorMaxElem(double max, string name = "Массив", string info = "Исходные данные") => Data.ShowColorElem(ShowHead, ShowColorElements, item => item == max);
        ...
        // вывод элементов
        private void ShowElements(double[] array)
        {
            // вывод рамки таблицы 
            ...
            Array.ForEach(array, delegate (double item) { ShowElem(i++, item); });
        ...
        // вывод элементов
        private void ShowColorElements(double[] array, Predicate<double> predicate)
        {
            // вывод рамки таблицы 
            ShowElemFrame(Data.Lenght);
            ...
            // вывод элементов массива
            Array.ForEach(array, delegate (double item) { ShowElem(i++, item, predicate(item)); });
        ...
        // вывод элементов
        static private void ShowElem(int num, double value, bool flagActiveColor = false, ConsoleColor colorIndex = ConsoleColor.DarkYellow, ConsoleColor colorValue = ConsoleColor.Green)
        {
            ...
            // вывод элемента 
            WriteColorXY($"{value,3:n1}", x, y + 2, textColor: flagActiveColor ? ConsoleColor.Cyan : colorValue);
