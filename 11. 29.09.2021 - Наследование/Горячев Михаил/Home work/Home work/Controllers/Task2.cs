...
namespace Home_work.Controllers
{
    ...
    internal class Task2
    {
        ...
        static private Figure[] GenFigures()
        {
            ...
            // конус
            figures[8] = FactoryFigure(CodeFigure.ConoidCode);
            ...
            // шар
            figures[4] = FactoryFigure(CodeFigure.SphereCode);
            figures[9] = FactoryFigure(CodeFigure.SphereCode);
        ...
        static private Figure FactoryFigure(CodeFigure code)
        {
            switch (code)
            {
                ...
                // шар
                case CodeFigure.SphereCode:
                    return new Sphere { Radius = GetDouble(2, 4) };
        ...
        #region Сортировка по возрастанию площади

        // сортировка по возрастанию площади
        public void SortAscendByArea()
        {
            // компаратор
            int Compare(Figure f1, Figure f2) => f1.GetArea.CompareTo(f2.GetArea);
