        ...
        */
        ...
        public void Task2()
        {
            ...
            while (true)
            {
                ...
                Console.SetCursorPosition(x, y++); Console.WriteLine("4. Сортировка по возрастанию площади");
                Console.SetCursorPosition(x, y++); Console.WriteLine("5. Выборка фигур с минимальной и максимальной площадью");
                ...
                try
                {
                    ...
                    switch (numberTask)
                    {
                        ...
                        // 4. Сортировка по возрастанию площади
                        ...
                        // 5. Выборка фигур с минимальной и максимальной площадью
            ...
            #region 4. Сортировка по возрастанию площади

            // 4. Сортировка по убыванию площади
            void Point4()
            {
                ShowNavBarMessage("4. Сортировка по возрастанию площади");
            ...
            #region 5. Выборка фигур с минимальной и максимальной площадью

            // 5. Выборка фигур с минимальной и максимальной площадью
            void Point5()
            {
                ShowNavBarMessage("5. Выборка фигур с минимальной и максимальной площадью");
