    ...
    public partial class App
    {
        ...
        public void Task1()
        {
            ...
            while (true)
            {
                ...
                Console.SetCursorPosition(x, y++); Console.WriteLine("4. Найти самое быстро и самое медленное транспортные средства");
                ...
                try
                {
                    ...
                    switch (numberTask)
                    {
                        ...
                        // 4. Найти самое быстро и самое медленное транспортные средства
            ...
            #region 4. Найти самое быстро и самое медленное транспортные средства

            // 4. Найти самое быстро и самое медленное транспортные средства
            void Point4()
            {
                ShowNavBarMessage("4. Найти самое быстро и самое медленное транспортные средства");
